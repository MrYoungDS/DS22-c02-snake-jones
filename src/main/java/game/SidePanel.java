...
public class SidePanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawString("Move Up: W / Up Arrow-key", LARGE_OFFSET, drawY += MESSAGE_STRIDE);
        g.drawString("Move Down: S / Down Arrow-key", LARGE_OFFSET, drawY += MESSAGE_STRIDE);
        g.drawString("Move Left: A / Left Arrow-key", LARGE_OFFSET, drawY += MESSAGE_STRIDE);
        g.drawString("Move Right: D / Right Arrow-key", LARGE_OFFSET, drawY += MESSAGE_STRIDE);
