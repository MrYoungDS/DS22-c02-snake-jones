...
public class SnakeGame extends JFrame {
    ...
    /**
     * Whether we are running a new game.
     */
    ...
    /**
     * The queue that contains the points for the snake.
     */
    private LinkedQueue<Point> snake;

    /**
     * The queue that contains the queued directions.
     */
    private LinkedQueue<Direction> directions;
    ...
    private void startGame() {
        ...
        this.snake = new LinkedQueue<>();
        this.directions = new LinkedQueue<>();
     ...
     * @return Tile that the head moved into.
     */
    private TileType updateSnake() {
         ...
         * after the update.
         */
        Point head = new Point(snake.peekLast());
        switch(direction) {
            case North:
                head.y--;
                break;
         ...
         * in case the tile we hit was the tailpiece that was just removed
        ...
        if(old != TileType.SnakeBody) {
            board.setTile(snake.peekLast(), TileType.SnakeBody);
            snake.enqueue(head);
    ...
    /**
     * Gets the flag that indicates whether we're playing a new game.
    ...
    /**
     * Gets the flag that indicates whether the game is over.
    ...
    /**
     * Gets the flag that indicates whether the game is paused.
    ...
    public static void main(String[] args) {
        SnakeGame snakeMain = new SnakeGame();
        snakeMain.startGame();
    }
